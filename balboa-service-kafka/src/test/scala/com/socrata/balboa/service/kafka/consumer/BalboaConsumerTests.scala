...
import com.socrata.balboa.common.codec.{StringCodec, BalboaMessageCodec}
...
object BalboaConsumerComponentSetup extends MockitoSugar {
   ...
   */
  trait TestBalboaKafkaConsumerSetup extends DataStoreConsumerComponent with MockKafkaStream {
