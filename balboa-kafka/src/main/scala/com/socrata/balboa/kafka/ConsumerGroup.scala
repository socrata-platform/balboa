...
import com.socrata.balboa.kafka.consumer.{KafkaConsumer, ConsoleConsumer}
...
case class ::(consumer: ConsumerConnector, topic: String, threads: Int) extends ConsumerGroup
