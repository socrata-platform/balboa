...
object Dependencies {
  ...
  val hawkular_client = "org.hawkular.client" % "hawkular-java-client" % versions.hawkular_client excludeAll(ExclusionRule(organization = "org.slf4j"), ExclusionRule(organization = "org.jboss.resteasy", name = "jaxrs-api"))
